...
export class Day2Stack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: Day2StackProps) {
    ...
    const securityGroup = new ec2.SecurityGroup(this, 'Day2AppSg', {
      ...
      description: 'Security group for Day 2 application',
    ...
    userData.addCommands(
      ...
      '',
      'echo "=========================================="',
      'echo "Day 2: EC2 Setup Script Started"',
      'echo "Timestamp: $(date)"',
      'echo "=========================================="',
      '',
      ...
      '',
      '# Node.js 24.xのインストール',
      'echo "[6/9] Installing Node.js 24.x..."',
      ...
      '',
      '# Docker Composeでdb-server、ldap-server、minioを起動',
      'echo "[8/9] Starting db-server, ldap-server, and minio with Docker Compose..."',
      'sudo -u ubuntu docker compose up -d db-server ldap-server minio',
      '',
      '# app-serverをEC2で直接実行',
      ...
      '',
      'echo "=========================================="',
      'echo "Day 2: EC2 Setup Script Completed"',
      'echo "Timestamp: $(date)"',
      'echo "=========================================="',
      '',
